...
public class BDScripts {
	...
	public ArrayList<String> getVersion1() {
		...
		String createIndex = "CREATE INDEX IDX_BLACK_LISTE1 ON BLACK_LISTE (ID_BLACKLIST) ;"
				+ "CREATE INDEX IDX_COMPTES ON COMPTES (ID_COMPTE); "
				+ "CREATE INDEX IDX_DOSSIER1 ON DOSSIER (ID_DOSSIER); "
				+ "CREATE INDEX IDX_MAIL_ENVOYE1 ON MAIL_ENVOYE (ID_MESSAGE_ENVOYE); "
				+ "CREATE INDEX IDX_MAIL_ENVOYE2 ON MAIL_ENVOYE (UID_MESSAGE); "
				+ "CREATE INDEX IDX_MAIL_ENVOYE3 ON MAIL_ENVOYE (DATE_ENVOI); "
				+ "CREATE UNIQUE INDEX IDX_MAIL_RECU ON MAIL_RECU (ID_MESSAGE_RECU); "
				+ "CREATE INDEX IDX_MAIL_RECU1 ON MAIL_RECU (UID_MESSAGE); "
				+ "CREATE INDEX IDX_MAIL_RECU2 ON MAIL_RECU (DATE_RECEPTION); "
				+ "CREATE INDEX IDX_RELGES1 ON REGLES (ID_REGLE);"
				+ "CREATE INDEX IDX_PIECE_JOINTE ON PIECE_JOINTE (ID_PIECE_JOINTE);";
