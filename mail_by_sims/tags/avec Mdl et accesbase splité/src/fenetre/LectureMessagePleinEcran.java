...
public class LectureMessagePleinEcran extends JFrame {
	...
	public LectureMessagePleinEcran(JTable p_table, int p_idMessage) {
		...
		this.setTitle(accesMail.getSujetFromId(p_idMessage));

	}

	private void afficheContenuMail(int p_idMessage, JList p_jList) {
		File contenu = accesMail.getContenuFromId(p_idMessage, true);
		...
		ArrayList<String> lstPj = accesPJ.getListNomPieceJointe(p_idMessage);
