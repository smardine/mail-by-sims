...
public class MlActionJtable implements MouseListener, ActionListener {
	...
	public void mouseReleased(MouseEvent e) {
		...
		if (e.isPopupTrigger()) {
			...
			if (table.getSelectedRowCount() == 1) {
				...
				boolean succes = accesMail.setStatusLecture(jTableHelper
	...
	public static void afficheContenuMail(JTable table, JList jList) {
		...
		if (selectedLine >= 0) {
			...
			AccesTableMailRecu accesMail = new AccesTableMailRecu();
			File contenu = accesMail.getContenuFromId(idMessage, false);
			...
			if (contenu != null) {
				try {
					...
					ArrayList<String> lstPj = new AccesTablePieceJointe()
	...
	public void actionPerformed(ActionEvent e) {
		if (table.getSelectedRowCount() == 1) {
			...
			AccesTableMailRecu accesMail = new AccesTableMailRecu();
			boolean succes = accesMail.setStatusLecture(jTableHelper
					.getReelIdMessage(table, table.getSelectedRow()));
			if (succes) {
